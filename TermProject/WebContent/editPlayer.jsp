...
<script type="text/javascript">
	function deleteConfirm(id){
		if(confirm("해당 선수를 삭제합니다!")==true)
			location.href="./deletePlayer.jsp?id="+id;
		else
			return;
	}
	...
	<div class="container">
		<div class="row" align="center">
			...
			<div class="col-md-4">
				...
				<p><%=rs.getString("p_number") %>
				<p><%=rs.getString("p_age") %>세
				<p><%
					if(edit.equals("update")){
						%>
						<a href="./updatePlayer.jsp?id=<%=rs.getString("p_id")%>"
